...
llamadoRol(tipoUsuario:String, nombreUsuario:String, rol:String, personaExclusiva:boolean){
  ...
  var sql = "insert into usuarios(tipoUsuario,nombreUsuario,rol,personaExclusiva) values ('" + tipoUsuario+ "','"+ nombreUsuario+ "','"+ rol + "','"+ personaExclusiva+"');";
